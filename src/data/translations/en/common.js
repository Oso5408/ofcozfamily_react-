...
export const common = {
  ...
  hero: {
    title: "Welcome to",
    subtitle: "Experience the purr-fect getaway with our six adorable resident cats. Book your cat-friendly room and create unforgettable memories! 🐾",
    cta: "Book Your Place",
...
*In support of environmental protection, please bring your own lidded water bottle.`,
      ...
      "LobbySeatDescription": `*Enjoy a comfortable seat in our lobby area with access to WiFi and cat-friendly environment.
...
All who rent a workspace can enjoy the supporting services in the shared area, including free coffee and tea | free high-speed wireless internet | microwave use | printing and scanning services (for a fee) | locker rental service (for a fee) | drinks in the refrigerator (for a fee)`
  ...
  footer: {
    copyright: "© 2025 Ofcoz Family. All rights reserved. Made with 🐾 for cat lovers."
  }
};
